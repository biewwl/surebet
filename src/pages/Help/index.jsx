...
function Help() {
  ...
  return (
    <main className="help">
      <Logo />
      <section className="help__steps">
        <section className="content help__steps__step">
        ...
        <section className="content help__steps__step">
          <SectionTitle title="Passo 4" icon="material-symbols-light:deployed-code-outline" />
          <p className={`c-${theme}`}>Na tela do Apps Script, faça o deploy.</p>
          <span className={`c-${theme}-1 help__steps__step__guide`}>
